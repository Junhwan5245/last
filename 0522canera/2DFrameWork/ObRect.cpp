...
void ObRect::CreateStaticMember()
{
    ...
    Vertex[0].color = Color(RANDOM->Float(), RANDOM->Float(), RANDOM->Float(), 1.0f);
    //좌 상단
    Vertex[1].position.x = -0.5f;
    Vertex[1].position.y = 0.5f;
    Vertex[1].color = Color(RANDOM->Float(), RANDOM->Float(), RANDOM->Float(), 1.0f);
    //우 하단
    Vertex[2].position.x = 0.5f;
    Vertex[2].position.y = -0.5f;
    Vertex[2].color = Color(RANDOM->Float(), RANDOM->Float(), RANDOM->Float(), 1.0f);
    //우 상단
    Vertex[3].position.x = 0.5f;
    Vertex[3].position.y = 0.5f;
    Vertex[3].color = Color(RANDOM->Float() , RANDOM->Float(), RANDOM->Float(), 1.0f);
